...
class Field extends React.Component<InternalFieldProps, FieldState>
  ...
  public getControlled = (childProps: ChildProps = {}) => {
    ...
    control[trigger] = event => {
      ...
      let newValue: StoreValue = event.target.value;
      // defaultGetValueFromEvent(
      //   valuePropName,
      //   ...args
      // );

      console.log("v", valuePropName, newValue); //sy-log
  ...
  public render() {
    ...
    if (isFunction) {
      ...
      const otherProps = this.getControlled(
